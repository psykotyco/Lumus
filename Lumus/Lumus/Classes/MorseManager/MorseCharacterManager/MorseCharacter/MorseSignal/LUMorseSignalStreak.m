...
@implementation LUMorseSignalStreak
...
-(void)showLightSignal {
    ...
    [self setTorchOn];
    [self performSelector:@selector(notifyShownSignal) withObject:nil afterDelay:[LUMorseContants getStreakSignalTime]];
}
